 ...
 * k_P: the proportional gain (>= 0)
 * k_I: the integral gain (>= 0)
 * k_D: the derivative gain (>= 0)
 * i_Zone: the integrator zone (>= 0) this is the zone where the integrator is active
 * i_maxAccum: the maximum accumulation of the integrator (>= 0) this is the maximum value that the
 */
public class PIDGains {
     ...
     * units are volt second per unit of measurement
     *
     ...
     * units are volts per unit of measurement per second
     ...
     * units are unit of measurement seconds
     *
     ...
     * this is used to convert the PID gains to motor gains
     * it is necessary to offset the gear ratio of the motor (that the output stays the same)
     ...
     * this is used to convert the PID gains to duty cycle gains
     * it is necessary if the motor controller uses a duty cycle instead of a voltage
