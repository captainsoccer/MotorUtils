...
/**
 * this class is used to store the gains of the controller
 * it is used to set the PID gains, feed forwards, and constraints
 */
public class ControllerGains {
    ...
    /**
     * the constraints of the controller
     ...
     * this is used to set the feed forwards of the motor controller
     */
     ...
     * this is used to update the motor controller on the slower thread
     */
