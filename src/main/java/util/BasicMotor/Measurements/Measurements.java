...
public abstract class Measurements {
  ...
  public record Measurement(double position, double velocity, double acceleration) {}
     ...
     * This is used to convert the measurements from the motor to the actual measurements
     */
  private double gearRatio;

    /**
     * The last measurement of the motor
     * This is used to store the last measurement of the motor
     */
