...
public class MeasurementsCTRE extends Measurements {
    ...
    public MeasurementsCTRE(StatusSignal<Angle> positionSignal, StatusSignal<AngularVelocity> velocitySignal,
                            StatusSignal<AngularAcceleration> accelerationSignal, double refreshHZ){
        this(positionSignal, velocitySignal, accelerationSignal, refreshHZ, 1.0);
    }

    public MeasurementsCTRE(StatusSignal<Angle> positionSignal, StatusSignal<AngularVelocity> velocitySignal,
                            StatusSignal<AngularAcceleration> accelerationSignal, double refreshHZ, double gearRatio){
        super(gearRatio);
