...
public class BasicSparkBaseConfig extends BasicMotorConfig{
    ...
    public static class ExternalEncoderConfig {
        ...
        /**
         * the number that the reading of the external encoder should be multiplied by to get the motor output
         * a value bigger than 1.0 is a reduction in the motor output. (the motor spins more than the sensor)
         */
        public double sensorToMotorRatio = 1.0;

        /**
         * the number that the reading of the external encoder should be divided by to get the mechanism output
         * a value bigger than 1.0 is a reduction in the mechanism output. (the sensor spins more than the mechanism)
         */
    ...
    public static class AbsoluteEncoderConfig {
        ...
        /**
         * the zero offset of the absolute encoder (in rotations)
         * the reading of the absolute encoder with this value will be considered zero
         */
        public double zeroOffset = 0.0;

        /**
         * the number that the reading of the absolute encoder should be multiplied by to get the motor output
         * a value bigger than 1.0 is a reduction in the motor output. (the motor spins more than the sensor)
         */
        public double sensorToMotorRatio = 1.0;

        /**
         * the number that the reading of the absolute encoder should be divided by to get the mechanism output
         * a value bigger than 1.0 is a reduction in the mechanism output. (the sensor spins more than the mechanism)
         */
        public double mechanismToSensorRatio = 1.0;

        /**
         * the range of the absolute encoder
         * this is used to determine the range of the absolute encoder
         * it can be set to ZERO_TO_ONE or HALF_ROTATION.
         */
        public BasicSparkBase.AbsoluteEncoderRange absoluteEncoderRange = BasicSparkBase.AbsoluteEncoderRange.ZERO_TO_ONE;
    }
}
