...
public class BasicMotorConfig {
    ...
    /**
     * the profile configuration of the motor controller
     * used for motion profiling and trajectory generation
     */
    public static class ProfileConfig {
         ...
         * if using a profiled position control, this is the maximum velocity
         * if using a profiled velocity control, this is the maximum acceleration
         */
         ...
         * this is used to create a motion profile for the motor controller
         * if using a profiled position control, this is the maximum acceleration
         * if using a profiled velocity control, this is the maximum jerk
         */
    ...
    public static class SimulationConfig {
        ...
        public static class ElevatorSimConfig {
            /**
             * if the elevator simulation should enable gravity simulation
             * if true, there will be a force acting on the elevator due to gravity
             * if false, the elevator will not be affected by gravity
             */
            public boolean enableGravitySimulation = true;

            /**
             * the mass of the elevator in kilograms
             * <p>this is used to simulate the elevator's mass in the simulation
             ...
             * <p>this is used to simulate the pulley radius in the simulation
             * if the kv and ka are provided, this will be ignored
             */
